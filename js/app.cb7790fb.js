	...
	var e = {
			1366: function (e, t, s) {
				...
				const a = { class: "hero" },
					...
					K = (0, r._)("span", { class: "hero__text-page" }, " Страницы: ", -1),
					U = (0, r._)("button", { class: "btn-reset hero__button-control hero__button-prev" }, "Пред", -1),
					Y = (0, r._)("button", { class: "btn-reset hero__button-control hero__button-next" }, "След.", -1),
					W = { class: "hero__text-onpage hero__text-footer" },
					Z = ["value"];
				function Q(e, t, s, i, D, M) {
				...
				const G = { class: "filters hero__filters" },
					...
					X = { class: "switch" },
					ee = (0, r._)("span", { class: "filters__text-switch switch__text" }, "Отклики", -1),
					te = (0, r._)("span", { class: "filters__text-switch switch__text" }, "Избранное", -1),
					se = [ee, te],
					oe = { class: "filters__container-statuses" },
					re = ["onClick"],
					ie = { class: "filters__list" },
					le = { class: "filters__title filters__title-category" },
					ae = { class: "filters__categories" },
					ne = ["value", "id", "onChange"],
					ce = ["for"],
					he = { class: "filters__container-buttons" };
				function de(e, t, s, i, a, n) {
						...
						(s(1632),
						{
							...
							methods: {
								...
								newFilterHandler(e, t) {
									const s = t.target;
									if (this.blockToggleCheckbox) console.log("blocked");
									else {
										let t = this.checkExistingFilter(e);
										-1 == t
											? this.$store.commit("addNewFilter", e)
											: this.$store.commit("deleteOldFilter", e, t),
											(this.blockToggleCheckbox = !0),
											setTimeout(() => {
												this.blockToggleCheckbox = !1;
											}, 300),
											s.classList.toggle("filters__checkbox-active"),
					...
					fe = {
						...
						data() {
							return {
								...
								modules: [ye.W_, ye.tl, ye.o3, ye.Qr],
							};
						},
						components: { HeroFilters: ve, Swiper: ge.tq, SwiperSlide: ge.o5 },
						setup() {
				...
				const be = (0, pe.Z)(fe, [["render", Q]]);
				var Se = be,
					ke = {
						name: "App",
						components: { HeroMain: Se },
						mounted() {
							this.$store.commit("saveRowsData");
						},
					};
				const xe = (0, pe.Z)(ke, [["render", i]]);
				var De = xe,
					Me = (s(7658), s(65)),
					$e = (0, Me.MT)({
						state: {
...
//# sourceMappingURL=app.cb7790fb.js.map
